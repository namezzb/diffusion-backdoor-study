...
| bibaddiff | imagenette2✅ + v1-5-pruned.ckpt✅ + PL 2.x 不兼容已修复 (15 patches) + precision=32 + num_workers=4 + check_val_every_n_epoch=999 + every_n_train_steps=10000 | 🔽 训练中 (step ~41400/56814, 72.9%, epoch 4, GPU 77%, 1.40GB RSS, 126 steps/min, ETA ~12:05 UTC) ✅ 5 checkpoints无OOM (29G) |
